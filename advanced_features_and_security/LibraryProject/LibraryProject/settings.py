...
SECRET_KEY = 'django-insecure-wsl^6fz2s(+9w6ua$mc+9je)4jlzsa!*5&)m1+(dywiya4=d!i'
...
SECURE_HSTS_SECONDS = 31536000  # Tell browsers to only communicate with the site over HTTPS for one year
